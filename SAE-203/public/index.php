        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <?php if (!empty($_SESSION['user'])): ?>
                    <a href="profil/profil.php" class="btn-search me-1" style="text-decoration:none;">👤
    ...
    <section class="container-fluid" id="principale">
        ...
        <script>
            $(document).ready(function () {
                ...
                // ── Mapping genre → image ───────────────────────────
                var genreImages = {
                    'horreur': 'assets/img/horreur.jpg',
                    'romance': 'assets/img/romance.jpg',
                    'action': 'assets/img/action.jpg',
                    'comedie': 'assets/img/comedie.jpg',
                    'aventure': 'assets/img/aventure.jpg',
                    'science_fiction': 'assets/img/science_fiction.jpg',
                    'western': 'assets/img/western.jpg',
                    'acteur': 'assets/img/acteur.jpg',
                    'directeur': 'assets/img/directeur.jpg',
                    'default': 'assets/img/romance.jpg'
                };
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background-color: rgb(214, 184, 102);">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="traitement/traitement.php" method="POST" id="form-inscription" novalidate autocomplete="off">
                            <div class="row">
                            ...
                            <p class="text-center mt-3 mb-0">
                                <a href="auth/login.php" class="text-white">Déjà un compte ? Se connecter</a>
                            </p>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background-color: rgb(214, 184, 102);">
                    ...
                    <div class="modal-body">
                        ...
                        <?php endif; ?>
                        <form action="user/login_auth.php" method="POST" autocomplete="off">
                            <div class="mb-3 text-start">
